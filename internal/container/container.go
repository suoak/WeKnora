...
func BuildContainer(container *dig.Container) *dig.Container {
	...
	must(container.Provide(repository.NewPortalRepository))
	must(container.Provide(repository.NewAuditLogRepository))
	must(container.Provide(repository.NewUsageAnalyticsRepository))
	...
	must(container.Provide(spreadsheetquery.NewService))
	...
	must(container.Invoke(chatpipeline.NewPluginSpreadsheetQuery))
