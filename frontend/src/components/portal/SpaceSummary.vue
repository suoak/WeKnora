...
.space-summary{position:relative;display:flex;min-width:0;min-height:164px;flex-direction:column;padding:16px;border:1px solid var(--portal-line);border-radius:11px;background:var(--td-bg-color-container);color:var(--portal-text-primary);box-shadow:0 1px 2px rgba(15,23,42,.025);cursor:pointer;transition:border-color .16s ease,background-color .16s ease,box-shadow .16s ease}.space-summary:hover,.space-summary:focus-visible,.space-summary:focus-within{border-color:color-mix(in srgb,var(--td-brand-color) 38%,var(--portal-line-strong));box-shadow:0 3px 10px rgba(15,23,42,.045);outline:2px solid var(--td-brand-color-focus);outline-offset:1px}.space-summary.current{border-color:color-mix(in srgb,var(--td-brand-color) 45%,var(--portal-line))}.space-summary.discoverable{background:color-mix(in srgb,var(--portal-surface-soft) 72%,var(--td-bg-color-container));color:var(--portal-text-secondary)}.summary-main{min-width:0;width:100%;flex:1}.space-title{display:flex;min-width:0;align-items:center;gap:7px}.space-title>.t-icon{flex:none;color:var(--portal-text-muted);font-size:16px}.space-title strong{display:block;min-width:0;overflow:hidden;font-size:15px;font-weight:650;line-height:21px;text-overflow:ellipsis;white-space:nowrap}.space-title span{flex:none;padding:2px 6px;border-radius:999px;background:var(--portal-brand-surface);color:var(--td-brand-color-active);font-size:12px;font-weight:600}.summary-main p{display:-webkit-box;min-height:40px;margin:7px 0 12px;overflow:hidden;color:var(--portal-text-secondary);font-size:13px;font-weight:400;line-height:20px;-webkit-box-orient:vertical;-webkit-line-clamp:2}.summary-main small{display:block;color:var(--portal-text-muted);font-size:12px;font-weight:500;line-height:18px}.accessible-actions{display:flex;align-items:center;justify-content:space-between;margin-top:14px}.icon-actions{display:flex;gap:5px}.accessible-actions button{height:30px;display:flex;align-items:center;justify-content:center;border:0;border-radius:7px;background:transparent;color:var(--portal-text-secondary);cursor:pointer;font:13px var(--portal-font-family)}.icon-actions button{width:30px;padding:0;font-size:17px}.accessible-actions .enter-action{gap:4px;padding:0 7px;color:var(--td-brand-color-active);font-weight:650}.accessible-actions button:hover,.accessible-actions button:focus-visible{background:var(--portal-brand-surface);color:var(--td-brand-color-active);outline:2px solid var(--td-brand-color-focus);outline-offset:1px}.restricted-action{display:flex;justify-content:flex-end;margin-top:14px}.restricted-action strong{display:flex;align-items:center;gap:3px;color:var(--portal-text-secondary);font-size:13px;font-weight:650}.space-summary.discoverable:hover .restricted-action strong,.space-summary.discoverable:focus-visible .restricted-action strong{color:var(--portal-text-primary)}.is-loading{cursor:default}
</style>
