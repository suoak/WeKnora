...
.public-knowledge{margin-top:22px;padding-top:18px;border-top:1px solid var(--td-component-stroke)}header{display:flex;align-items:flex-end;justify-content:space-between;gap:20px;margin-bottom:10px}h2{margin:0;font-size:17px;font-weight:650}header p{margin:3px 0 0;color:var(--td-text-color-secondary);font-size:11px}header>span{color:var(--td-text-color-placeholder);font-size:10px}.summary-loading{width:180px;flex:none}.public-grid{display:grid;grid-template-columns:repeat(3,minmax(0,360px));gap:10px}.public-empty{min-height:82px;display:grid;place-items:center;border:1px dashed var(--td-component-border);border-radius:10px;background:color-mix(in srgb,var(--td-bg-color-secondarycontainer) 40%,transparent);color:var(--td-text-color-placeholder);font-size:11px}@media(max-width:1599px){.public-grid{grid-template-columns:repeat(2,minmax(0,480px))}}@media(max-width:900px){header{align-items:flex-start;flex-direction:column;gap:6px}.summary-loading{width:100%}.public-grid{grid-template-columns:1fr}}
</style>
