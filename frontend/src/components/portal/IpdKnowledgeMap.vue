...
.ipd-map{margin-top:22px}.section-header{display:flex;align-items:flex-end;justify-content:space-between;gap:20px;margin-bottom:11px}.section-header h2{margin:0;font-size:18px;font-weight:600}.section-header p{margin:4px 0 0;color:var(--td-text-color-secondary);font-size:12px}.map-summary{display:flex;flex-wrap:wrap;justify-content:flex-end;gap:5px 12px;color:var(--td-text-color-placeholder);font-size:11px}.map-summary span:first-child{padding:3px 8px;border-radius:999px;background:var(--td-brand-color-light);color:var(--td-brand-color)}.summary-loading{width:220px;flex:none}.stage-scroll{min-width:0;overflow-x:visible;padding-bottom:5px;scrollbar-width:thin;scrollbar-color:var(--td-component-border) transparent}.stage-track{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));align-items:start;gap:7px}.stage-loading-card{min-width:0;padding:10px;border:1px solid var(--td-component-stroke);border-radius:10px;background:var(--td-bg-color-container)}.stage-loading-card .space-summary{min-height:74px;margin-top:10px}
@media(max-width:1319px){.stage-scroll{overflow-x:auto;overscroll-behavior-inline:contain;mask-image:linear-gradient(to right,#000 0,#000 calc(100% - 30px),transparent 100%)}.stage-track{grid-template-columns:none;grid-auto-flow:column;grid-auto-columns:minmax(172px,1fr);min-width:max-content;padding-right:30px}}
