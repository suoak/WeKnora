...
.public-overview{grid-template-columns:auto minmax(280px,1fr)}.public-space-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.public-loading,.public-empty{min-height:180px;display:grid;place-items:center;border:1px dashed var(--td-component-border);border-radius:12px;color:var(--td-text-color-secondary);background:var(--td-bg-color-secondarycontainer)}@media(max-width:1024px){.public-space-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:680px){.public-overview,.public-space-grid{grid-template-columns:1fr}}
</style>
