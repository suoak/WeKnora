...
.portal-shell{width:100%;height:100%;min-height:100vh;display:flex;overflow:hidden;background:#f3f5f4}.portal-page{--portal-font-family:-apple-system,BlinkMacSystemFont,"Segoe UI","Microsoft YaHei UI","Microsoft YaHei","PingFang SC","Noto Sans CJK SC",sans-serif;--portal-page-title:32px;--portal-section-title:21px;--portal-text-primary:#111827;--portal-text-secondary:#475569;--portal-text-muted:#64748b;--portal-page-surface:#f3f5f4;--portal-surface-soft:#f8faf9;--portal-surface-hover:#f4f7f5;--portal-brand-surface:#eef8f2;--portal-line:#e6eae8;--portal-line-strong:#d7ddda;min-width:0;min-height:0;flex:1;overflow-y:auto;background:var(--portal-page-surface);color:var(--portal-text-primary);font-family:var(--portal-font-family)}main{box-sizing:border-box;width:100%;max-width:1500px;margin:0 auto;padding:0 clamp(28px,2vw,40px) 56px}:global([theme-mode="dark"]) .portal-page{--portal-text-primary:var(--td-text-color-primary);--portal-text-secondary:rgba(255,255,255,.7);--portal-text-muted:rgba(255,255,255,.52);--portal-page-surface:var(--td-bg-color-page);--portal-surface-soft:var(--td-bg-color-secondarycontainer);--portal-surface-hover:var(--td-bg-color-container-hover);--portal-brand-surface:color-mix(in srgb,var(--td-brand-color) 10%,var(--td-bg-color-container));--portal-line:var(--td-component-stroke);--portal-line-strong:var(--td-component-border)}@media(max-width:800px){main{padding-left:62px}}@media(max-width:680px){.portal-page{--portal-page-title:26px;--portal-section-title:19px}main{padding:0 14px 36px 58px}}
</style>
