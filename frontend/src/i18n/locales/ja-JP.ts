...
const messages = {
  ...
  navigation: { main: 'Main navigation', openMenu: 'Open navigation', portalHome: 'Home', newChat: 'New chat', recentChats: 'Recent chats', recentAll: 'All', recentCollapse: 'Collapse', knowledgeBases: 'スペースのナレッジベース', agents: 'Agents', allAgents: 'All agents', members: 'スペースメンバー', managementCenter: '管理センター', integrations: 'Integrations', workspaceSettings: 'Workspace Settings', usageAnalytics: 'Usage Analytics', modelsDefaults: 'Models & Defaults', runtime: 'Runtime', audit: 'Audit', systemSettings: 'System Settings', platformApiKeys: 'Platform API Keys', groups: { global: 'グローバル', workspace: 'ナレッジスペース', management: '管理', knowledge: 'Knowledge', ai: 'AI', system: 'System Administration' } },
  spaceSwitcher: { currentSpace: 'Current space', search: 'Search spaces', current: 'Current space', unknown: 'Unknown space' },
  portalCard: { ask: 'Q&A', search: 'ナレッジ検索', responsible: '担当：{name}', unconfigured: '未設定', noSpaceDescription: 'スペースの説明はありません' },
  ...
  knowledgeBase: {
    ...
    statusDraft: '下書き',
    noDescription: '説明なし',
    emptyCreated: 'ナレッジベースを作成しました',
    emptyAddFirst: '最初のナレッジを追加してください',
    emptyUploadHint: 'ファイルをアップロードすると、解析方法と推奨チャンク設定が自動選択されます。',
    emptyUploadFile: 'ファイルをアップロード',
  ...
  knowledgeList: {
    workspaceTitle: '{spaceName} · ナレッジベース',
    create: 'ナレッジベースを作成',
    filters: {
      searchPlaceholder: '名前または説明を検索',
      allPermissions: 'すべての権限', editable: '編集可能', readonly: '閲覧のみ',
      shared: '共有されたもの',
      allStatuses: 'すべての状態', ready: '利用可能', processing: '処理中', setup: '設定が必要',
      noResults: '一致するナレッジベースがありません', noResultsHint: '検索語、権限、状態フィルターを変更してください。', clear: 'フィルターを解除',
    },
    favorite: { add: 'お気に入りに追加', remove: 'お気に入りから削除' },
    access: { currentSpace: '現在のスペース', private: 'スペース内のみ', shared: '共有済み' },
  ...
  knowledgeEditor: {
    ...
    titleEdit: 'ナレッジベース設定',
    createFlow: {
      basicDescription: '名前と説明を入力すると、その他の設定は自動的に継承されます。',
      defaultsTitle: 'システム推奨設定を使用',
      defaultsDescription: 'モデル、解析、チャンク、ストレージ、ベクトルストアはシステム既定値を継承します。',
      showAdvanced: '詳細設定', hideAdvanced: '詳細設定を閉じる',
      missingEmbedding: '既定の Embedding モデルが設定されていません。システム管理者に連絡してください。',
