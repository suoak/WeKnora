...
export default {
  ...
  navigation: { main: 'Main navigation', openMenu: 'Open navigation', portalHome: 'Home', newChat: 'New chat', recentChats: 'Recent chats', knowledgeBases: 'Knowledge Bases', agents: 'Agents', members: 'Members', managementCenter: 'Центр управления', integrations: 'Integrations', workspaceSettings: 'Workspace Settings', usageAnalytics: 'Usage Analytics', modelsDefaults: 'Models & Defaults', runtime: 'Runtime', audit: 'Audit', systemSettings: 'System Settings', platformApiKeys: 'Platform API Keys', groups: { global: 'Глобально', workspace: 'Пространство знаний', management: 'Управление', knowledge: 'Knowledge', ai: 'AI', system: 'System Administration' } },
