...
const messages = {
  ...
  navigation: { main: 'Main navigation', openMenu: 'Open navigation', portalHome: 'Home', newChat: 'New chat', recentChats: 'Recent chats', recentAll: 'All', recentCollapse: 'Collapse', knowledgeBases: 'Базы знаний пространства', agents: 'Agents', allAgents: 'All agents', members: 'Участники пространства', managementCenter: 'Центр управления', integrations: 'Integrations', workspaceSettings: 'Workspace Settings', usageAnalytics: 'Usage Analytics', modelsDefaults: 'Models & Defaults', runtime: 'Runtime', audit: 'Audit', systemSettings: 'System Settings', platformApiKeys: 'Platform API Keys', groups: { global: 'Глобально', workspace: 'Пространство знаний', management: 'Управление', knowledge: 'Knowledge', ai: 'AI', system: 'System Administration' } },
