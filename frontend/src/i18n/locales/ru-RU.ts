...
const messages = {
  ...
  portal: {
    ...
    publicZone: { title: 'Зона общих знаний', empty: 'Общие пространства знаний пока не опубликованы.', types: { standards: 'Стандарты', templates: 'Шаблоны', training: 'Обучение', practices: 'Лучшие практики' } }, navigationTitle: 'Навигация по знаниям IPD',
    ...
    emptySearch: 'Подходящие пространства знаний не найдены.', emptyStage: 'На этом этапе нет опубликованных пространств.', emptyAll: 'Сейчас нет доступных для поиска пространств.', loadingSpaces: 'Загрузка пространств знаний…', resultsShowing: 'Показано {visible} из {total}', loadMoreSpaces: 'Показать ещё', collapseSpaces: 'Свернуть список',
  ...
  usageAnalytics: {
	...
	tokenType: 'Тип токенов', direction: 'Направление', operationDistribution: 'Распределение операций', foregroundTokens: 'Интерактивные токены', backgroundTokens: 'Фоновые токены',
	tokenScopePhase2: 'Включены Chat, Agent, основные фоновые Chat-операции, а также provider usage для Memory и Wiki. Embedding, Rerank, VLM и ASR пока не включены.',
	filters: { all: 'Все', foreground: 'Интерактивные', background: 'Фоновые', inbound: 'Входящие', outbound: 'Исходящие' },
    ...
    title: 'Аналитика использования', description: 'Токены Assistant Turn и входящие вызовы MCP.', range: 'Период', sort: 'Сортировка пространств', days: 'дней', refresh: 'Обновить', loading: 'Загрузка…', empty: 'За этот период данных нет.', loadFailed: 'Не удалось загрузить аналитику.', collectingSince: 'Статистика собирается с {date}.', unattributed: 'Общий шлюз / Без привязки', tokenScope: 'Текущая статистика Token охватывает видимые пользователю Knowledge QA и Agent assistant turn. Часть фоновых вызовов будет добавлена позже.', mcpScope: 'Вызовы общего шлюза не позволяют надежно определить пользователя или пространство и отображаются без привязки.', tokenBreakdown: 'Разбивка Token', trend: 'Динамика использования',
    tabs: { overview: 'Обзор', spaces: 'Пространства', token: 'Token', mcp: 'MCP', knowledgeBases: 'Базы знаний' }, metrics: { tokens: 'Учтенные Token', mcpCalls: 'Вызовы MCP', activeTenants: 'Активные пространства', activePrincipals: 'Активные субъекты', totalCalls: 'Всего вызовов', unattributed: 'MCP без привязки' },
    sorts: { tokens: 'Token', mcpCalls: 'MCP Calls', activePrincipals: 'Active Principals', lastActive: 'Last Active' },
    columns: { tenant_name: 'Пространство', active_principals: 'Активные субъекты', assistant_turns: 'Assistant Turns', agent_turns: 'Agent Turns', input_tokens: 'Input Token', output_tokens: 'Output Token', total_tokens: 'Total Token', mcp_calls: 'MCP Calls', mcp_success_rate: 'MCP Success Rate', mcp_avg_latency_ms: 'MCP Avg Latency', last_active: 'Последняя активность', model_id: 'Модель', model_type: 'Тип модели', cache_read_tokens: 'Cache Read', cache_write_tokens: 'Cache Write', tool_name: 'Инструмент', calls: 'Calls', successful_calls: 'Successful Calls', success_rate: 'Success Rate', average_latency_ms: 'Average Latency', unattributed_calls: 'Unattributed Calls', knowledge_base_name: 'База знаний', owner_tenant_name: 'Пространство-владелец', caller_tenant_name: 'Вызывающее пространство', input: 'Input', output: 'Output', cacheRead: 'Cache Read', cacheWrite: 'Cache Write', successRate: 'Success Rate', avgLatency: 'Average Latency' },
  },
  platformApiKeys: {
  ...
  modelSettings: {
    defaultPolicy: {
      invalidConfigured: 'Настроенная модель больше недоступна. Выберите другую модель или очистите эту настройку.',
      title: 'Системная политика моделей по умолчанию', description: 'Используется, когда модель не задана явно; изменения применяются сразу.',
      chat: 'Модель чата', summary: 'Модель сводки', embedding: 'Модель Embedding',
      rerank: 'Модель Rerank', vlm: 'Модель VLM', asr: 'Модель ASR', unconfigured: 'Не настроено',
      embeddingSafety: 'Смена Embedding по умолчанию влияет только на новые базы знаний и не перестраивает существующие индексы.',
      saved: 'Системная политика моделей сохранена', saveFailed: 'Не удалось сохранить системную политику моделей',
      badges: { chat: 'Чат по умолчанию', summary: 'Сводка по умолчанию', embedding: 'Вектор по умолчанию', rerank: 'Реранк по умолчанию', vlm: 'Зрение по умолчанию', asr: 'Речь по умолчанию' }
    },
  ...
  knowledgeList: {
    workspaceTitle: '{spaceName} · Базы знаний',
    create: 'Создать базу знаний',
    filters: {
