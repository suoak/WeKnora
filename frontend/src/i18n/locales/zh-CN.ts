...
export default {
  ...
  portalMap: { ipdTitle: 'IPD 知识建设全景图', ipdDescription: '查看 IPD 全生命周期各阶段已建设的知识空间与知识资产规模。', coverage: '覆盖 {covered}/{total} 阶段', stageInventory: '{spaces} 个知识空间 · {kb} 个知识库 · {files} 个文件', spaceInventory: '{kb} 个知识库 · {files} 个文件', emptyStage: '暂无知识空间', noAccess: '暂无访问权限', enterSpace: '进入空间', ask: '提问', accessDialog: { title: '知识空间访问', notice: '当前账号暂未获得该知识空间访问权限。', pending: '申请处理中', contactAdmin: '请联系该知识空间管理员获取访问权限。' } },
  menu: {
