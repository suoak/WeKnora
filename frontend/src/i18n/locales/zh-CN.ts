...
export default {
  ...
  portal: {
    ...
    heroEyebrow: '知识发现',
    heroTitle: '发现组织中经过治理的知识空间',
    heroDescription: '沿 IPD 流程浏览专业知识，申请所需空间的 Viewer 只读权限。',
    viewSwitcherLabel: '知识门户视图',
    views: { ipd: 'IPD 知识流程', ipdDescription: '按产品研发阶段浏览', public: '公共知识专区', publicDescription: '按已配置的公共知识空间浏览' },
    publicZone: { title: '公共知识专区', empty: '暂未发布公共知识空间。', types: { standards: '制度与标准', templates: '模板与工具', training: '培训材料', practices: '最佳实践' } },
    flowOverview: { eyebrow: 'IPD 知识建设', title: 'IPD 知识建设全景图', description: '直观看到每个 IPD 阶段由哪些已治理知识空间支撑；选择阶段可在下方查看完整空间列表。', coverageMetric: '阶段覆盖', spacesMetric: '关联空间', knowledgeBasesMetric: '知识库', filesMetric: '文件', coveredStagesMetric: '已覆盖阶段', stageSpaceCount: '{count} 个空间', inventory: '{kb} 库 · {files} 文件', noSpaces: '暂未建设已发布空间', moreSpaces: '另有 {count} 个，点击查看', viewAll: '查看全部空间' },
    navigationTitle: 'IPD 知识导航',
    navigationDescription: '阶段用于流程筛选，知识领域用于组织分类；同一空间只展示一次。',
    spaceCount: '{count} 个空间',
    mySpacesTitle: '我的知识空间',
    mySpacesDescription: '已拥有真实有效成员权限的工作空间，包括未发布到门户的空间。',
    noMySpaces: '您还没有加入任何知识空间，可以从下方知识门户发现并申请所需空间。',
    stageNavigationLabel: 'IPD 流程阶段',
    allStages: '全部',
    allStagesDescription: '所有已发布空间',
    searchPlaceholder: '搜索空间名称、描述、知识领域或阶段',
    allCategories: '全部知识领域',
    emptySearch: '未找到匹配的知识空间。',
    emptyStage: '当前阶段暂无已发布知识空间。',
    emptyAll: '当前暂无可发现的知识空间。',
    loadingSpaces: '正在加载知识空间…',
    resultsShowing: '已显示 {visible} / {total} 个空间',
    loadMoreSpaces: '加载更多',
    collapseSpaces: '收起列表',
    featured: '精选',
    noDescription: '该空间暂未填写说明。',
    categoryTag: '领域 · {category}',
    ...
    enterWorkspace: '进入空间',
    requestAccess: '申请访问',
    enterInteraction: '进入交互空间',
    requestTitle: '申请只读访问',
    submitRequest: '提交申请',
    viewerOnly: '固定权限：Viewer / 只读访问',
    reasonPlaceholder: '请说明您需要访问该空间的原因',
    requestSuccess: '访问申请已提交，等待空间所有者审核。',
    requestFailed: '提交访问申请失败',
    permissionChanged: '权限状态已经变化，请重新确认可访问范围。',
    interactionFailed: '无法进入交互空间',
    loadFailed: '知识门户加载失败',
    ...
    stages: {
      concept_market: { name: '概念 / 市场', description: '机会识别与市场洞察' },
      concept_product: { name: '概念 / 产品', description: '产品概念与需求定义' },
      architecture: { name: '架构', description: '系统与技术架构' },
      design: { name: '设计', description: '方案与详细设计' },
      development: { name: '开发', description: '研发实现与构建' },
      testing: { name: '测试', description: '验证与质量保障' },
      lmt: { name: 'LMT', description: '上市与生命周期管理' }
    },
    requests: {
      title: '访问申请', description: '仅工作空间所有者可审批；通过后固定授予 Viewer 只读权限。',
      loading: '正在加载访问申请…', empty: '当前没有待审核的门户访问申请。', applicant: '申请人 {id}',
      approve: '批准', reject: '拒绝', approveSuccess: '已授予 Viewer 权限', rejectSuccess: '已拒绝申请',
      applicantUnavailable: '当前申请人账号不可用，无法授予空间权限。', loadFailed: '访问申请加载失败', reviewFailed: '处理访问申请失败'
    },
    admin: {
      menuEntry: '平台管理 · 知识门户', back: '返回知识门户', eyebrow: '平台治理', title: '知识门户配置',
      description: '维护知识发现元数据；内容权限仍由工作空间 RBAC 决定。', refresh: '刷新', unconfigured: '尚未配置',
  ...
  knowledgeEditor: {
    ...
    titleEdit: '知识库设置',
    createFlow: {
      basicDescription: '填写名称和描述即可创建，其余配置由系统自动继承。',
      defaultsTitle: '已使用系统推荐配置',
      defaultsDescription: '模型、解析、分块、存储与向量库将继承系统默认设置，可直接创建。',
      showAdvanced: '高级设置',
      hideAdvanced: '收起高级设置',
      missingEmbedding: '系统尚未配置默认 Embedding 模型，请联系系统管理员。',
      configureModel: '前往配置模型',
    },
    advanced: {
      title: '高级设置',
  ...
  knowledgeList: {
    ...
    filters: {
      ...
      setup: '待配置',
      noResults: '没有匹配的知识库',
      noResultsHint: '尝试调整搜索词、权限或状态筛选。',
      clear: '清除筛选',
    },
    favorite: { add: '添加收藏', remove: '取消收藏' },
  ...
  knowledgeBase: {
    ...
    emptyCreated: '知识库已创建',
    emptyAddFirst: '现在添加第一份知识',
    emptyUploadHint: '直接上传文件，系统会自动选择解析方式并使用推荐分块配置。',
    emptyUploadFile: '上传文件',
  ...
  navigation: { main: '主导航', openMenu: '打开导航', portalHome: '首页', newChat: '新对话', recentChats: '最近对话', recentAll: '全部', recentCollapse: '收起', knowledgeBases: '知识库', agents: '智能体', allAgents: '全部智能体', members: '成员', managementCenter: '管理中心', integrations: '集成', workspaceSettings: '空间设置', usageAnalytics: '用量分析', modelsDefaults: '模型与默认值', runtime: '运行状态', audit: '审计', systemSettings: '系统设置', platformApiKeys: '平台 API Keys', groups: { global: '全局', workspace: '知识空间', management: '管理', knowledge: '知识', ai: 'AI', system: '系统管理' } },
  spaceSwitcher: { currentSpace: '当前空间', search: '搜索空间', current: '当前', unknown: '未知空间' },
  portalExperience: { eyebrow: 'CSBU 研发知识门户', heroTitle: 'CSBU 全流程知识支撑平台', heroDescription: '让研发知识围绕 IPD 生命周期持续沉淀、连接、检索、问答与复用。', scaleLabel: '已发布知识资产规模', scaleTooltip: '统计已发布到 CSBU 知识门户的知识空间及知识资产规模，具体内容访问受空间权限控制。', spaces: '知识空间', knowledgeBases: '知识库', files: '文件', searchPlaceholder: '搜索知识、文档，或直接输入研发问题', currentScope: '当前空间：{space}', noActiveScope: '请先选择知识空间', quickActionsLabel: '快捷入口', selectSpaceFirst: '请先选择一个可访问的知识空间。', quickActions: { search: '知识检索', browse: '浏览知识', agent: '智能体', tools: 'AI 工具接入' } },
  ...
  portalMap: { ipdTitle: 'IPD 全生命周期知识地图', ipdDescription: '查看 IPD 全生命周期各阶段已建设的知识空间与知识资产规模。', allStageSpaces: '全阶段知识空间', stageShort: { concept1: '机会识别', concept2: '需求定义', architecture: '技术架构', design: '方案设计', development: '研发实现', testing: '验证质量', lmt: '生命周期' }, coverage: '覆盖 {covered}/{total} 阶段', stageInventory: '{spaces} 个知识空间 · {kb} 个知识库 · {files} 个文件', stageInventoryCompact: '{spaces} 空间 · {kb} 库 · {files} 文件', spaceInventory: '{kb} 个知识库 · {files} 个文件', spaceInventoryCompact: '{kb} 库 · {files} 文件', emptyStage: '暂无知识空间', noAccess: '暂无访问权限', permissionRequired: '需要权限', getAccess: '获取访问权限', learnAccess: '了解获取权限', enterSpace: '进入空间', enter: '进入', search: '搜索', ask: '提问', accessDialog: { title: '知识空间访问', titleWithSpace: '访问“{space}”', notice: '你可以发现该知识空间', explanation: '但当前账号尚未获得内容访问权限。', spaceLabel: '知识空间', stageLabel: '所属阶段', afterAccess: '获得权限后，可以：', browse: '浏览知识库', search: '搜索内容', ask: '使用知识问答', pending: '申请处理中', contactAdmin: '请联系该知识空间管理员获取访问权限。' } },
  menu: {
