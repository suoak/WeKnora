...
export default {
  ...
  portal: {
    ...
    publicZone: { eyebrow: '公共知识空间', title: '公共知识专区', description: '汇集公共数据、项目资料与可复用知识，具体内容仍按空间权限安全开放。', empty: '暂未发布公共知识空间。', types: { standards: '制度与标准', templates: '模板与工具', training: '培训材料', practices: '最佳实践' } },
