...
export default {
  ...
  portal: {
    ...
    publicZone: { eyebrow: '公共知识空间', title: '公共知识专区', description: '集中发现通过 Portal 配置发布的全部公共知识空间；实际内容访问仍严格遵循工作空间 RBAC。', empty: '暂未发布公共知识空间。', types: { standards: '制度与标准', templates: '模板与工具', training: '培训材料', practices: '最佳实践' } },
  ...
  navigation: { main: '主导航', openMenu: '打开导航', portalHome: '首页', newChat: '新对话', recentChats: '最近对话', knowledgeBases: '知识库', agents: 'Agent', members: '成员', managementCenter: '管理中心', integrations: '集成', workspaceSettings: '空间设置', usageAnalytics: '用量分析', modelsDefaults: '模型与默认值', runtime: '运行状态', audit: '审计', systemSettings: '系统设置', platformApiKeys: '平台 API Keys', groups: { global: '全局', workspace: '知识空间', management: '管理', knowledge: '知识', ai: 'AI', system: '系统管理' } },
  spaceSwitcher: { currentSpace: '当前空间', search: '搜索空间', current: '当前', unknown: '未知空间' },
  portalExperience: { eyebrow: '知识建设全景', heroTitle: 'CSBU 全流程知识支撑平台', heroDescription: '围绕 IPD 全生命周期，统一沉淀、检索、问答与复用研发知识。', scaleLabel: '已发布知识资产规模', scaleTooltip: '统计已发布到 CSBU 知识门户的知识空间及知识资产规模，具体内容访问受空间权限控制。', spaces: '知识空间', knowledgeBases: '知识库', files: '文件', searchPlaceholder: '搜索知识、文档，或输入问题', currentScope: '当前空间：{space}', noActiveScope: '请先选择知识空间', quickActionsLabel: '快捷入口', selectSpaceFirst: '请先选择一个可访问的知识空间。', quickActions: { search: '知识检索', browse: '浏览知识', agent: 'Agent', tools: 'AI 工具接入' } },
  ...
  portalMap: { ipdTitle: 'IPD 知识建设全景图', ipdDescription: '查看 IPD 全生命周期各阶段已建设的知识空间与知识资产规模。', coverage: '覆盖 {covered}/{total} 阶段', stageInventory: '{spaces} 个知识空间 · {kb} 个知识库 · {files} 个文件', stageInventoryCompact: '{spaces} 空间 · {kb} 库 · {files} 文件', spaceInventory: '{kb} 个知识库 · {files} 个文件', spaceInventoryCompact: '{kb} 库 · {files} 文件', emptyStage: '暂无知识空间', noAccess: '暂无访问权限', enterSpace: '进入空间', ask: '提问', accessDialog: { title: '知识空间访问', notice: '当前账号暂未获得该知识空间访问权限。', pending: '申请处理中', contactAdmin: '请联系该知识空间管理员获取访问权限。' } },
  menu: {
