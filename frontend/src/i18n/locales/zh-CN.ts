...
export default {
  ...
  portal: {
    ...
    stages: {
      ...
      concept_product: { name: '概念2', description: '需求定义' },
      architecture: { name: '架构', description: '技术架构' },
      design: { name: '设计', description: '方案设计' },
      development: { name: '开发', description: '研发实现' },
      testing: { name: '测试', description: '验证质量' },
      lmt: { name: 'LMT', description: '生命周期' }
    },
    requests: {
  ...
  navigation: { main: '主导航', openMenu: '打开导航', portalHome: '首页', newChat: '新对话', recentChats: '最近对话', recentAll: '全部', recentCollapse: '收起', knowledgeBases: '空间知识库', agents: '智能体', allAgents: '全部智能体', mcpAccess: 'MCP 接入', members: '空间成员', managementCenter: '管理中心', integrations: '集成', workspaceSettings: '空间设置', usageAnalytics: '用量分析', modelsDefaults: '模型与默认值', runtime: '运行状态', audit: '审计', systemSettings: '系统设置', platformApiKeys: '平台 API Keys', groups: { global: '全局', workspace: '知识空间', management: '管理', knowledge: '知识', ai: 'AI', system: '系统管理' } },
