...
export default {
  ...
  navigation: { main: 'Main navigation', openMenu: 'Open navigation', portalHome: 'Home', newChat: 'New chat', recentChats: 'Recent chats', knowledgeBases: 'Knowledge Bases', agents: 'Agents', members: 'Members', managementCenter: '관리 센터', integrations: 'Integrations', workspaceSettings: 'Workspace Settings', usageAnalytics: 'Usage Analytics', modelsDefaults: 'Models & Defaults', runtime: 'Runtime', audit: 'Audit', systemSettings: 'System Settings', platformApiKeys: 'Platform API Keys', groups: { global: '글로벌', workspace: '지식 공간', management: '관리', knowledge: 'Knowledge', ai: 'AI', system: 'System Administration' } },
