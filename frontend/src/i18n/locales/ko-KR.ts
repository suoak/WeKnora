...
const messages = {
  ...
  navigation: { main: 'Main navigation', openMenu: 'Open navigation', portalHome: 'Home', newChat: 'New chat', recentChats: 'Recent chats', recentAll: 'All', recentCollapse: 'Collapse', knowledgeBases: '공간 지식베이스', agents: 'Agents', allAgents: 'All agents', members: '공간 멤버', managementCenter: '관리 센터', integrations: 'Integrations', workspaceSettings: 'Workspace Settings', usageAnalytics: 'Usage Analytics', modelsDefaults: 'Models & Defaults', runtime: 'Runtime', audit: 'Audit', systemSettings: 'System Settings', platformApiKeys: 'Platform API Keys', groups: { global: '글로벌', workspace: '지식 공간', management: '관리', knowledge: 'Knowledge', ai: 'AI', system: 'System Administration' } },
