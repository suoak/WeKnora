...
export default {
  ...
  portal: {
    ...
    stages: {
      concept_market: { name: 'Concept / Market', description: 'Opportunity and market insight' },
      concept_product: { name: 'Concept / Product', description: 'Product concept and requirements' },
      architecture: { name: 'Architecture', description: 'System and technical architecture' },
      design: { name: 'Design', description: 'Detailed solution design' },
      development: { name: 'Development', description: 'Implementation and build' },
      testing: { name: 'Testing', description: 'Verification and quality assurance' },
      lmt: { name: 'LMT', description: 'Launch and lifecycle management' }
    },
    requests: {
