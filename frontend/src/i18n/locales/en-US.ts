...
export default {
  ...
  portal: {
    ...
    publicZone: { eyebrow: 'PUBLIC KNOWLEDGE SPACES', title: 'Public Knowledge Zone', description: 'Bring public data, project material, and reusable knowledge together while keeping content protected by space permissions.', empty: 'No public knowledge spaces have been published yet.', types: { standards: 'Standards', templates: 'Templates', training: 'Training', practices: 'Best practices' } },
  ...
  navigation: { main: 'Main navigation', openMenu: 'Open navigation', portalHome: 'Home', newChat: 'New chat', recentChats: 'Recent chats', knowledgeBases: 'Knowledge Bases', agents: 'Agents', members: 'Members', managementCenter: 'Management Center', integrations: 'Integrations', workspaceSettings: 'Workspace Settings', usageAnalytics: 'Usage Analytics', modelsDefaults: 'Models & Defaults', runtime: 'Runtime', audit: 'Audit', systemSettings: 'System Settings', platformApiKeys: 'Platform API Keys', groups: { global: 'Global', workspace: 'Knowledge Space', management: 'Management', knowledge: 'Knowledge', ai: 'AI', system: 'System Administration' } },
