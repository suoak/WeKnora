...
export default {
  portal: {
    ...
    views: { ipd: 'IPD knowledge flow', ipdDescription: 'Browse by product-development stage', public: 'Public knowledge zone', publicDescription: 'Standards, templates, training, and practices' },
    publicZone: { eyebrow: 'SHARED ORGANIZATIONAL ASSETS', title: 'Public Knowledge Zone', description: 'Discover reusable organizational standards, templates, training materials, and proven practices. Access to actual content still follows workspace RBAC.', empty: 'No public knowledge spaces have been published yet.', types: { standards: 'Standards', templates: 'Templates', training: 'Training', practices: 'Best practices' } },
