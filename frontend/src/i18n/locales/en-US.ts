...
export default {
  ...
  portal: {
    ...
    admin: {
      ...
      descriptionLabel: 'Description', responsibleTeam: 'Responsible team', contact: 'Contact', ipdStages: 'IPD stages', displayOrder: 'Display order',
