...
export default {
  ...
  portal: {
    ...
    publicZone: { eyebrow: 'PUBLIC KNOWLEDGE SPACES', title: 'Public Knowledge Zone', description: 'Discover all public knowledge spaces published through Portal configuration. Access to actual content still follows workspace RBAC.', empty: 'No public knowledge spaces have been published yet.', types: { standards: 'Standards', templates: 'Templates', training: 'Training', practices: 'Best practices' } },
  ...
  portalExperience: { eyebrow: 'Knowledge panorama', heroTitle: 'CSBU full-process knowledge support platform', heroDescription: 'Built around the full IPD lifecycle, bringing research knowledge together for discovery, Q&A, and reuse.', scaleLabel: 'Published knowledge asset scale', scaleTooltip: 'Counts knowledge spaces and assets published to the CSBU Knowledge Portal. Access to specific content is controlled by space permissions.', spaces: 'Knowledge spaces', knowledgeBases: 'Knowledge bases', files: 'Files', searchPlaceholder: 'Search knowledge and documents, or ask a question', currentScope: 'Current space: {space}', noActiveScope: 'Select a knowledge space first', quickActionsLabel: 'Quick actions', selectSpaceFirst: 'Select a knowledge space before using this action.', quickActions: { search: 'Search knowledge', browse: 'Browse knowledge', agent: 'Agent', tools: 'AI tool access' } },
