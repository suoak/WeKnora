...
export default {
  ...
  portal: {
    ...
    heroTitle: 'Discover governed knowledge spaces across the organization',
    heroDescription: 'Browse professional knowledge along the IPD process and request Viewer read-only access when needed.',
    viewSwitcherLabel: 'Knowledge Portal views',
    views: { ipd: 'IPD knowledge flow', ipdDescription: 'Browse by product-development stage', public: 'Public knowledge zone', publicDescription: 'Browse configured public knowledge spaces' },
    publicZone: { title: 'Public Knowledge Zone', empty: 'No public knowledge spaces have been published yet.', types: { standards: 'Standards', templates: 'Templates', training: 'Training', practices: 'Best practices' } },
    flowOverview: { eyebrow: 'IPD KNOWLEDGE CONSTRUCTION', title: 'IPD Knowledge Landscape', description: 'See which governed knowledge spaces support every IPD stage. Select a stage to review its complete space list below.', coverageMetric: 'stage coverage', spacesMetric: 'associated spaces', knowledgeBasesMetric: 'knowledge bases', filesMetric: 'files', coveredStagesMetric: 'covered stages', stageSpaceCount: '{count} spaces', inventory: '{kb} KB · {files} files', noSpaces: 'No published space', moreSpaces: '+{count} more; select to view', viewAll: 'View all spaces' },
    navigationTitle: 'IPD Knowledge Navigation',
    navigationDescription: 'Stages filter the process and categories organize knowledge domains; each space appears only once.',
    spaceCount: '{count} spaces',
    mySpacesTitle: 'My Knowledge Spaces',
    mySpacesDescription: 'Workspaces where you have active membership, including spaces not published in the Portal.',
    noMySpaces: 'You have not joined any knowledge spaces. Discover and request a space below.',
    stageNavigationLabel: 'IPD process stages',
    allStages: 'All',
    allStagesDescription: 'All published spaces',
    searchPlaceholder: 'Search space name, description, category, or stage',
    allCategories: 'All knowledge domains',
    emptySearch: 'No matching knowledge spaces found.',
    emptyStage: 'No published knowledge spaces are available at this stage.',
    emptyAll: 'No knowledge spaces are currently discoverable.',
    loadingSpaces: 'Loading knowledge spaces…',
    resultsShowing: 'Showing {visible} of {total} spaces',
    loadMoreSpaces: 'Load more',
    collapseSpaces: 'Collapse list',
    featured: 'Featured',
    noDescription: 'No description has been provided for this space.',
    categoryTag: 'Domain · {category}',
    ...
    enterInteraction: 'Enter interaction space',
    requestTitle: 'Request read-only access',
    submitRequest: 'Submit request',
    viewerOnly: 'Fixed permission: Viewer / read-only',
    reasonPlaceholder: 'Explain why you need access to this space',
    requestSuccess: 'Access request submitted for Owner review.',
    requestFailed: 'Failed to submit the access request',
    permissionChanged: 'Your permission state changed. Review the available access again.',
    interactionFailed: 'Unable to enter the interaction space',
    loadFailed: 'Failed to load the Knowledge Portal',
    roles: { owner: 'Owner', admin: 'Admin', contributor: 'Contributor', viewer: 'Viewer' },
    stageDetail: { current: 'CURRENT IPD STAGE', resultTitle: 'Knowledge spaces for this stage', resultCount: '{count} matching spaces' },
    categories: { insight_domain: 'Insight', market_customer: 'Market & customer', requirements_management: 'Requirements management', architecture_design: 'Architecture & design', development_assets: 'Development assets', test_quality: 'Test & quality', operations_lifecycle: 'Operations & lifecycle', process_governance: 'Process governance', public_knowledge: 'Public knowledge' },
    stages: {
    ...
    requests: {
      title: 'Access requests', description: 'Only workspace Owners can review requests. Approval always grants Viewer read-only access.',
      loading: 'Loading access requests…', empty: 'There are no pending Portal access requests.', applicant: 'Applicant {id}',
      approve: 'Approve', reject: 'Reject', approveSuccess: 'Viewer access granted', rejectSuccess: 'Request rejected',
      applicantUnavailable: 'The applicant account is unavailable, so workspace access cannot be granted.', loadFailed: 'Failed to load access requests', reviewFailed: 'Failed to process the access request'
    },
    admin: {
      menuEntry: 'Platform · Knowledge Portal', back: 'Back to Knowledge Portal', eyebrow: 'PLATFORM GOVERNANCE', title: 'Knowledge Portal settings',
      description: 'Manage discovery metadata. Content access remains governed by workspace RBAC.', refresh: 'Refresh', unconfigured: 'Not configured',
      workspaceNumber: 'Workspace #{id}', displayName: 'Portal display name', category: 'Category (knowledge domain / organization)',
      categoryPlaceholder: 'Select or create a knowledge domain', categoryHelp: 'Choose a knowledge domain. Custom values are supported, but IPD stage keys such as architecture, design, or testing are not allowed.',
      groups: { basicTitle: 'Basic information', basicDescription: 'What users see on the Portal card.', positioningTitle: 'Knowledge positioning', positioningDescription: 'Category defines the knowledge domain; stages define where it supports the IPD flow.', displayTitle: 'Display settings', displayDescription: 'Control recommendation and ordering without changing access rights.', accessTitle: 'Access and interaction', accessDescription: 'Configure Viewer requests and an optional organization interaction entry. Existing permissions still apply.' },
      descriptionLabel: 'Space description', responsibleTeam: 'Responsible owner / team', contact: 'Contact', ipdStages: 'IPD stages', displayOrder: 'Display order',
      interactionOrganization: 'Interaction organization', noInteractionOrganization: 'No interaction space', featured: 'Featured', allowAccessRequest: 'Allow Viewer access requests',
      save: 'Save settings', saveHint: 'Saving settings does not change publication status.', publishStatus: 'Publication status', publish: 'Publish', unpublish: 'Unpublish', archive: 'Archive',
      statuses: { draft: 'Draft', published: 'Published', archived: 'Archived' },
      loadFailed: 'Failed to load Portal settings', saveSuccess: 'Portal settings saved', saveFailed: 'Failed to save settings', statusSuccess: 'Publication status updated', statusFailed: 'Failed to update status'
    }
  },
  navigation: { main: 'Main navigation', openMenu: 'Open navigation', portalHome: 'Home', newChat: 'New chat', recentChats: 'Recent chats', recentAll: 'All', recentCollapse: 'Collapse', knowledgeBases: 'Space Knowledge Bases', agents: 'Agents', allAgents: 'All agents', mcpAccess: 'MCP Access', members: 'Space Members', managementCenter: 'Management Center', integrations: 'Integrations', workspaceSettings: 'Workspace Settings', usageAnalytics: 'Usage Analytics', modelsDefaults: 'Models & Defaults', runtime: 'Runtime', audit: 'Audit', systemSettings: 'System Settings', platformApiKeys: 'Platform API Keys', groups: { global: 'Global', workspace: 'Knowledge Space', management: 'Management', knowledge: 'Knowledge', ai: 'AI', system: 'System Administration' } },
  spaceSwitcher: { currentSpace: 'Current space', search: 'Search spaces', current: 'Current space', unknown: 'Unknown space' },
  portalCard: { ask: 'Q&A', search: 'Knowledge search', responsible: 'Responsible: {name}', unconfigured: 'Not configured', noSpaceDescription: 'No space description' },
  portalExperience: { eyebrow: 'CSBU R&D Knowledge Base', heroTitle: 'CSBU full-process R&D knowledge support platform', heroDescription: 'Connect market insight, R&D, and lifecycle management so knowledge can be captured, connected, searched, questioned, and reused.', scaleLabel: 'Currently visible R&D knowledge assets', scaleTooltip: 'Counts knowledge spaces and assets published to the CSBU Knowledge Portal. Access to specific content is controlled by space permissions.', spaces: 'Knowledge spaces', knowledgeBases: 'Knowledge bases', files: 'Files', searchPlaceholder: 'Search knowledge and documents, or enter an R&D question', currentScope: 'Current space: {space}', noActiveScope: 'Select a knowledge space first', quickActionsLabel: 'Quick actions', selectSpaceFirst: 'Select a knowledge space before using this action.', quickActions: { search: 'Search knowledge', browse: 'Browse knowledge', agent: 'Agent', tools: 'AI tool access' } },
  ...
  portalMap: { ipdTitle: 'IPD Lifecycle Knowledge Map', ipdDescription: 'R&D knowledge is continuously captured and reused across the IPD lifecycle.', allStageSpaces: 'IPD knowledge spaces', stageIdentity: '{name} stage', stageShort: { insight: 'Market insight', concept1: 'Opportunity', concept2: 'Requirements', architecture: 'Architecture', design: 'Solution design', development: 'Engineering', testing: 'Quality validation', lmt: 'Lifecycle' }, stageFallback: { insight: 'Market insight and opportunity signals', concept1: 'Market opportunity and concept exploration', concept2: 'Product concept and requirements definition', architecture: 'System and technology architecture', design: 'Solution and detailed design', development: 'Engineering implementation and build', testing: 'Validation and quality assurance', lmt: 'Launch and lifecycle management' }, stageCount: '{count} IPD stages', coverage: 'Knowledge coverage {covered} / {total}', stageSpaceCountCompact: '{count} spaces', stageInventory: '{spaces} spaces · {kb} knowledge bases · {files} files', stageInventoryCompact: '{spaces} spaces · {kb} KB · {files} files', spaceInventory: '{kb} knowledge bases · {files} files', spaceInventoryCompact: '{kb} KB · {files} files', emptyStage: 'No knowledge space yet', noAccess: 'No access yet', permissionRequired: 'Permission required', getAccess: 'Get access', learnAccess: 'How to get access', enterSpace: 'Enter space', enter: 'Enter', search: 'Search', ask: 'Ask', accessDialog: { title: 'Knowledge space access', titleWithSpace: 'Access “{space}”', notice: 'You can discover this knowledge space', explanation: 'Your account has not yet been granted access to its content.', spaceLabel: 'Knowledge space', stageLabel: 'IPD stage', afterAccess: 'With access, you can:', browse: 'Browse knowledge bases', search: 'Search content', ask: 'Use knowledge Q&A', pending: 'Access request in progress', contactAdmin: 'Contact the knowledge space administrator to request access.' } },
  menu: {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: `Everything starts here: upload documents, web pages or FAQs and ${branding.productName} parses and indexes them automatically. Click here to open knowledge bases.`
      },
      chat: {
  ...
  settings: {
    ...
    sandbox: {
      ...
      templateLoadHint: `Enter the cluster connection and refresh. If there is no ${branding.productName} standard template, click Create; after changing DNS or the image, click Delete and rebuild.`,
      ...
      templateStepHint: `This step only lists templates already on the cluster; it does not create one automatically. Click Create ${branding.productName} standard template if none exists, or Delete and rebuild after changing DNS or the image. You can continue after a template is ready.`,
      ...
      templateUntaggedHint: `The builds finished but none carries the default tag, so sandbox creation cannot resolve this template. Delete it in E2B and refresh; ${branding.productName} will rebuild it.`,
  ...
  auth: {
    ...
    firstTime: `New to ${branding.productName}?`,
    registerSuccess: 'Registration successful. Please sign in',
    registerFailed: 'Registration failed',
    subtitle: 'RAG Q&A, ReAct Agent and Wiki — an LLM-powered enterprise knowledge framework',
    registerSubtitle: `Create your account and start using ${branding.productName}`,
  ...
  knowledgeList: {
    ...
    workspaceTitle: '{spaceName} · Knowledge bases',
  ...
  integrations: {
    ...
    api: {
      ...
      hmacSecretDesc: `Same secret stored in ${branding.productName}; used only on your backend to sign JWTs—never send it as a request header.`,
    ...
    chrome: {
      ...
      subtitle: `For self-hosted ${branding.productName}: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.`,
      ...
      steps: {
        ...
        port: {
          ...
          desc: `On ${branding.productName} Desktop, set a fixed API port (e.g. 37841) in API Info so the URL stays stable across restarts.`
        },
        install: {
    ...
    claw: {
      ...
      subtitle: `Import documents and run hybrid retrieval (vector + keyword) via the ${branding.productName} REST API—for uploads, URL imports, Markdown entries, and cross-KB search.`,
      ...
      installCtaHint: `Install ${branding.productName} Skill · opens in a new tab`,
  ...
  usageAnalytics: {
	...
	tokenType: 'Token type', direction: 'Direction', operationDistribution: 'Operation Distribution', foregroundTokens: 'Foreground Token', backgroundTokens: 'Background Token',
	tokenScopePhase2: 'Included: Knowledge QA, Agent, major background Chat operations, Memory, and Wiki provider usage. Not yet included: Embedding, Rerank, VLM, and ASR.',
	filters: { all: 'All', foreground: 'Foreground interaction', background: 'Background processing', inbound: 'Inbound', outbound: 'Outbound' },
	operations: { knowledge_qa_turn: 'Knowledge QA', agent_turn: 'Agent', agent_compaction: 'Agent compaction', query_rewrite: 'Query rewrite', entity_extraction: 'Entity extraction', data_analysis_planning: 'Data analysis planning', document_summary: 'Document summary', generated_questions: 'Generated questions', auto_tag: 'Automatic tags', graph_extraction: 'Graph extraction', spreadsheet_metadata: 'Spreadsheet metadata', session_title: 'Session title', memory_extraction: 'Memory extraction', memory_consolidation: 'Memory consolidation', memory_topic_resolution: 'Memory topic resolution', wiki_ingestion: 'Wiki ingestion', wiki_generation: 'Wiki generation', wiki_modification: 'Wiki modification', mcp_instruction_generation: 'MCP instruction generation' },
