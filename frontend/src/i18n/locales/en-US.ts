...
export default {
  ...
  navigation: { main: 'Main navigation', openMenu: 'Open navigation', portalHome: 'Home', newChat: 'New chat', recentChats: 'Recent chats', recentAll: 'All', recentCollapse: 'Collapse', knowledgeBases: 'Space Knowledge Bases', agents: 'Agents', allAgents: 'All agents', members: 'Space Members', managementCenter: 'Management Center', integrations: 'Integrations', workspaceSettings: 'Workspace Settings', usageAnalytics: 'Usage Analytics', modelsDefaults: 'Models & Defaults', runtime: 'Runtime', audit: 'Audit', systemSettings: 'System Settings', platformApiKeys: 'Platform API Keys', groups: { global: 'Global', workspace: 'Knowledge Space', management: 'Management', knowledge: 'Knowledge', ai: 'AI', system: 'System Administration' } },
