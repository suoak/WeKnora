...
export default {
  ...
  usageAnalytics: {
	...
	tokenScopePhase2: 'Included: Knowledge QA, Agent, compaction, rewrite, extraction, summaries, generated questions, automatic tags, graph and spreadsheet metadata, session titles, and MCP instruction generation. Not yet included: Embedding, Rerank, VLM, ASR, Memory, and Wiki provider usage.',
