...
const MESSAGES = {
  zh: {
    ...
    navChat: "问答",
    navSettings: "设置",
    knowledgeTitle: "知汇知识库",
    knowledgeSubtitle: "在微信中选择知识库，导入网页或提问。",
    needsSettings: "请先配置知汇 API 地址和 API Key，再加载知识库。",
    openSettings: "打开设置",
    knowledgeBase: "知识库",
    tapToSelect: "点击选择",
    refreshKnowledgeBases: "刷新知识库列表",
    urlLabel: "网页链接",
    urlPlaceholder: "https://knowhub.example.com",
    importUrl: "导入链接",
    ...
    settingsTitle: "连接知汇",
    settingsSubtitle: "填写知汇 API 地址与租户 API Key。",
    apiBaseUrl: "API 地址",
    apiBaseUrlPlaceholder: "https://knowhub.example.com",
    apiKey: "API Key",
    ...
    saveSettings: "保存设置",
    saved: "已保存",
    missingBaseUrl: "请先配置知汇 API 地址。",
    missingApiKey: "请先配置知汇 API Key。"
  },
  en: {
    ...
    knowledgeTitle: "KnowHub Knowledge",
    knowledgeSubtitle: "Import a web page into a selected knowledge base from WeChat.",
    needsSettings: "Configure the KnowHub API base URL and API key before loading knowledge bases.",
    ...
    chatSubtitle: "Ask the selected KnowHub knowledge base.",
    question: "Question",
    questionPlaceholder: "Ask something...",
    askWeKnora: "Ask KnowHub",
    answer: "Answer",
    chatFailed: "Chat failed",
    sessionIdMissing: "The session API did not return a session id.",
    settingsTitle: "Connect KnowHub",
    settingsSubtitle: "Use your KnowHub API endpoint and tenant API key.",
    ...
    saved: "Saved",
    missingBaseUrl: "Please configure the KnowHub API base URL first.",
    missingApiKey: "Please configure the KnowHub API key first."
  }
};
